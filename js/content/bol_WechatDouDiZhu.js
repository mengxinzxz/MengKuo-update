...
const brawl = {
    ...
    intro: [
        ...
        '【跋扈】：锁定技。①准备阶段，你摸一张牌。②你使用【杀】的额定次数+1。',
            ...
            const changeFunction = {
                    ...
                    chooseCharacter() {
                        ...
                        next.setContent(async function (event, trigger, player) {
                            for (const i of game.players) {
                                if (i == game.me) i.init(lib.config.extension_活动萌扩_chooseSex);
                            ...
                            for (const target of game.players) {
                                const result = await target.chooseButton(['请选择你的初始技能', [target.OriginalSkills.map(name => ['', '', 'skillCard_' + name]), 'vcard']], true, game.zhu == target ? 3 : 2).forResult();
                                if (result?.bool && result.links?.length) map[target.playerid] = result.links.map(i => i[2].slice(10));
                            }
                            for (const i of game.players) {
                                delete i.max_beishu;
                                if (map[i.playerid]?.length > 0) i.addSkill(map[i.playerid]);
                            }
                ...
                lib: {
                    character: (() => {
                        const character = {
                            //男
                            bol_unknown_male0: ['male', 'qun', 4, []],
                            bol_unknown_male1: ['male', 'qun', 4, []],
                            bol_unknown_male2: ['male', 'qun', 4, []],
                            bol_unknown_male3: ['male', 'qun', 4, []],
                            bol_unknown_male4: ['male', 'qun', 4, []],
                            bol_unknown_male5: ['male', 'qun', 4, []],
                            bol_unknown_male6: ['male', 'qun', 4, []],
                            //女
                            bol_unknown_female0: ['female', 'qun', 4, []],
                            bol_unknown_female1: ['female', 'qun', 4, []],
                            bol_unknown_female2: ['female', 'qun', 4, []],
                            bol_unknown_female3: ['female', 'qun', 4, []],
                            bol_unknown_female4: ['female', 'qun', 4, []],
                            bol_unknown_female5: ['female', 'qun', 4, []],
                            bol_unknown_female6: ['female', 'qun', 4, []],
                        };
                    ...
                    translate: {
                        ...
                        zhu2: '地主',
                        fan2: '农民',
                        bol_unknown_male0: '士兵',
                        bol_unknown_male1: '步兵',
                        bol_unknown_male2: '常山府军',
                        bol_unknown_male3: '江夏弓骑兵',
                        bol_unknown_male4: '太行山游侠',
                        bol_unknown_male5: '武林山隐伏',
                        bol_unknown_male6: '羽林内军',
                        bol_unknown_female0: '士兵',
